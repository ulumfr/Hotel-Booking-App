      ...
      () => Scaffold(
        ...
        body: SizedBox(
          ...
          child: Column(
            children: [
              Expanded(
                child: controller.onboardingData.isEmpty
                          ...
                          return Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Container(
                                  margin:
                                      const EdgeInsets.only(bottom: 7, top: 25),
                                  child: Text(
                                    controller.onboardingData[i].text,
                                    style: const TextStyle(
                                      fontSize: 27,
                                ...
                                Container(
                                  ...
                                  child: Text(
                                    controller.onboardingData[i].dsc,
